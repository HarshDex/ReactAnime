...
const Login = () => {
  return (
    <div className="h-screen w-full bg-[url('https://www.ghibli.jp/gallery/ged025.jpg')] bg-cover overflow-scroll">
      <div className="h-full w-full backdrop-brightness-[80%] p-[10em] ">
        <div className="h-full w-full flex items-center justify-center">
          {/* <---- Glassmorphsism ----> */}
          <div className="flex flex-col px-[5em] py-[5em] sm:px-[7em] sm:py-[7em] bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-gray-100 space-y-7 sm:space-y-10">
            <div>
